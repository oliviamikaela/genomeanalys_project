...
#Commands
fastqc -o ~/genomeanalysis_project/analyses/02_check_quality_RNA/serum -f fastq \
...
fastqc -o ~/genomeanalysis_project/analyses/02_check_quality_RNA/serum -f fastq -c\
