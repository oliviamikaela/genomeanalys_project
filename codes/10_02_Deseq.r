...
res_p0_001_FC2 <- subset(myres,pvalue<0.001&abs(log2FoldChange)>2)
res_p0_001_FC2[order(res_p0_001_FC2[["log2FoldChange"]]),]

write.csv(as.data.frame(res_p0_001_FC2), file="~/genomeanalysis_project/analyses/10_deseq/res_p0_001_FC2.csv")

#Plot Volcano plot
png(file='~/genomeanalysis_project/analyses/10_deseq/plot_res_p0_001_FC2.png')
...
#Plot MA plot
png(file='~/genomeanalysis_project/analyses/10_deseq/plotMA_FC2.png')
